...
import { Search, ArrowRight, GraduationCap, BookOpen, Bot, CheckSquare, Sparkles, Building2, Users, Award, ChevronRight, ChevronDown } from "lucide-react";
        ...
        <div className="mx-auto max-w-7xl px-4 pb-20 pt-16 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-full border border-zinc-500/50 bg-white/10 px-4 py-1.5 text-sm text-zinc-300 backdrop-blur-sm transition-colors hover:bg-white/20 hover:text-white mb-4"
            >
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              <Link href="/programmes" className="group">
                <div className="rounded-xl border border-zinc-600/40 bg-white/[0.08] p-5 backdrop-blur-sm transition-all hover:bg-white/[0.15] hover:border-[#0FA3B1]/50">
                  <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-blue-500/20">
                    <BookOpen className="h-6 w-6 text-blue-400" />
                  </div>
                  <h3 className="mt-3 text-lg font-semibold text-white">Available Programmes</h3>
                  <p className="mt-1 text-sm text-zinc-400">Browse all programmes offered across faculties and schools</p>
                </div>
              </Link>
              <Link href="/admission-checker" className="group">
                <div className="rounded-xl border border-zinc-600/40 bg-white/[0.08] p-5 backdrop-blur-sm transition-all hover:bg-white/[0.15] hover:border-[#0FA3B1]/50">
                  ...
                  <h3 className="mt-3 text-lg font-semibold text-white">Check Eligibility</h3>
                  <p className="mt-1 text-sm text-zinc-400">Enter your subjects and grades to see which programmes you qualify for</p>
                </div>
              </Link>
              <Link href="/ai-advisor" className="group">
                <div className="rounded-xl border border-zinc-600/40 bg-white/[0.08] p-5 backdrop-blur-sm transition-all hover:bg-white/[0.15] hover:border-[#0FA3B1]/50">
                  <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-xl bg-purple-500/20">
                    <Bot className="h-6 w-6 text-purple-400" />
                  </div>
                  <h3 className="mt-3 text-lg font-semibold text-white">AI Advisor</h3>
                  <p className="mt-1 text-sm text-zinc-400">Get personalized programme recommendations and career guidance</p>
                </div>
              </Link>
            </div>
          </div>
...
{ step: "02", title: "Get Matched", desc: "Our system evaluates your eligibility against programme requirements." },
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-zinc-600 dark:text-zinc-400">Popular programmes</p>
            </div>
